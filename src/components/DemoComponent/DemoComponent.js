...
export default function DemoComponent() {
  let category = _.uniqBy(data, "tenDanhMuc");
  let [maDanhMuc, setMaDanhMuc] = useState(category[0].maDanhMuc);
          ...
          <section className="text-gray-600 body-font ">
            <div className="container px-5 py-24 mx-auto">
              <div className="flex flex-wrap -m-4">
                {_.filter(data, (value) => value.maDanhMuc === maDanhMuc).map(
                  (dish, index) => {
                    return (
