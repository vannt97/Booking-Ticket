...
import { signUpAction } from "../../redux/actions/UserManagementAction";
        ...
        <div className="mt-8">
          <form onSubmit={handleSubmit}>
            ...
            {errors.maNhom && touched.maNhom && (
              <span className="text-red-700">{errors.maNhom}</span>
            )}
            <div className="mt-5">
              <div className="text-sm font-bold text-gray-700 tracking-wide">
                Họ Tên
...
const SignInFormik = withFormik({
  ...
  validationSchema: Yup.object().shape({
    ...
    soDt: Yup.string().required("Bạn chưa nhập số điện thoại"),
    maNhom: Yup.string().required("Bạn chưa nhập mã nhóm"),
...
export default connect()(SignInFormik);
